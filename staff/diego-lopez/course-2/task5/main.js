let membersArr
fetch('https://v3.openstates.org/people?jurisdiction=California&page=1&per_page=10',{
  headers:{
...
//function getChamberTittle(){
//  (membersArr[i].current_role.org_classification === "lower") ? "Assembly Member": "Senator"}
